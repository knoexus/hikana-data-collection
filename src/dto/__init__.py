...
class CompleteWord(KanshudoWord):
    def __init__(self, kanji: str | None, kana: str | None, occurence_level: int, jlpt_level: int, translations_eng: [str]) -> None:
        super().__init__(kanji, kana, occurence_level, jlpt_level)
        self.translations_eng = translations_eng

    def __str__(self) -> str:
        return f'{super().__str__()}, english translations: {", ".join(self.translations_eng)}'
